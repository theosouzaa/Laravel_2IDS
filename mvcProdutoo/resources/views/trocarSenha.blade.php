...
<body>
    ...
    <div class="container">
        ...
        <form action="{{ route('senha.trocar') }}" method="POST">
            ...
            <div class="form-group">
                <label for="corredor">Nova Senha</label>
                <input type="password" name="password" id="password" placeholder="senha de 6 dígitos" required>
            </div>

            <button type="submit" value="Alterar Senha" class="btn">
                Alterar Senha
            </button>
        </form>
